...
with Home:
    ...
    with c2:
        st.markdown("<h1 style=\"margin:.1rem 0 .6rem 0\"> Dockyard Acoustics Sound Technology </h2>")
        st.markdown("<h2 style=\"margin:.1rem 0 .6rem 0\">State of the art Acoustic Simulation Software</h2>", unsafe_allow_html=True)
